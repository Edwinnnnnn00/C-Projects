    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                || ourAnimals[i, 4] == "Physical description: " || ourAnimals[i, 4] == "Physical description: tbd"))
                {
                    do
                    {
                    ...
                    do
                    {
                        Console.WriteLine($"Enter a physical description for ID #: {ourAnimals[i, 0].Substring(6)} (size, color, breed, gender, weight, housebroken)");
                        readResult = Console.ReadLine();
        ...
        case "4":
            ...
            {
                // string 
                if ((ourAnimals[i, 0] != "ID #: ") && (ourAnimals[i, 3] == "Nickname: tbd" || ourAnimals[i, 3] == "Nickname: "
                || ourAnimals[i, 5] == "Personality: tbd" || ourAnimals[i, 5] == "Personality: "))
                {
                    do
                    {
                        Console.WriteLine($"Enter an nickname for ID #: {ourAnimals[i, 0].Substring(6)}");
                        readResult = Console.ReadLine();
                        if (readResult == null || readResult == "")
                        {
                            validEntry = false;
